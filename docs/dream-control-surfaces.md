...
The grievance/Meta co-browse feeds **atlasStore**, where a screenshot alone is
...
that replays offline — and drops it straight into the atlasStore intake with
...
4. **§7 evidence capture** — the atlasStore payoff verb.
